...
SRC = minishell.c init_colors.c \
	...
	utils/ft_strccpy.c utils/ft_strcmp.c utils/malloc_node.c utils/del_qout_nodes.c utils/ft_strjoin_path.c utils/ft_putstr_fd_malloc.c \
    ...
    utils/print_node.c utils/ft_strndup.c utils/free_info.c \
