...
SRC = minishell.c init_colors.c \
	...
	utils/free_nodes.c utils/free_split.c utils/ft_restore_value.c utils/init_info.c utils/pre_split.c utils/print_array2d.c utils/is_qout.c utils/builtins_message.c \
